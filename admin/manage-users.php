...
?>
    ...
    <?php elseif (isset($_SESSION['edit-user-success'])) : // show if edit user was successful ?> 
        ...
        <?php elseif (isset($_SESSION['delte-user'])) : // show if delete user was NOT successful ?> 
        <div class="alert__message error container ">
            <p>
        ...
        <?php elseif (isset($_SESSION['delete-user-success'])) : // show if delete user was NOT successful ?> 
        <div class="alert__message success container ">
            <p>
